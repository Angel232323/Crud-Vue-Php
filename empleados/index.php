...
if(isset($_GET["insertar"])){
    ...
    $sqlEmpleaados = mysqli_query($conexionBD,"INSERT INTO empleados(nombre,email) VALUES('$nombre','$correo') ");
    echo json_encode(["success"=>1]);
        }
    exit();
}
...
if(isset($_GET["actualizar"])){
    ...
    $sqlEmpleaados = mysqli_query($conexionBD,"UPDATE empleados SET nombre='$nombre',email='$correo' WHERE id='$id'");
    echo json_encode(["success"=>1]);
    exit();
}
